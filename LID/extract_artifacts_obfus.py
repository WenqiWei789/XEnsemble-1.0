...
from LID.util_obfus import (get_data, get_noisy_samples, get_mc_predictions,
...
def get_lid(model, X_test, X_test_noisy, X_test_adv, k=10, batch_size=10, dataset='mnist'):
    """
